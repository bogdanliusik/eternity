...
public class UserSession
{
    ...
    private UserSession(Guid userId, string refreshToken, DateTime refreshTokenExpiry, string? ipAddress,
        string? userAgent) {
        Id = Guid.NewGuid();
        UserId = userId;
    ...
    public static UserSession Create(Guid userId, string refreshToken, DateTime refreshTokenExpiry, string? ipAddress,
        string? userAgent) {
