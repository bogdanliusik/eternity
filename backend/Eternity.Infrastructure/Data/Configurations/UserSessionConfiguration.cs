...
public class UserSessionConfiguration : IEntityTypeConfiguration<UserSession>
{
    public void Configure(EntityTypeBuilder<UserSession> builder) {
        ...
        builder.Property(x => x.RefreshTokenExpiry).IsRequired();
        ...
        builder.Property(x => x.DeviceInfo).HasMaxLength(128);
        builder.Property(x => x.BrowserInfo).HasMaxLength(128);
        builder.Property(x => x.IsTerminated).HasDefaultValue(false).IsRequired();
        builder.Property(x => x.IsOnline).HasDefaultValue(false).IsRequired();
