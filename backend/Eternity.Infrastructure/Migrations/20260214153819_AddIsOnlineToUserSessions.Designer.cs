...
namespace Eternity.Infrastructure.Migrations
{
    ...
    [Migration("20260214153819_AddIsOnlineToUserSessions")]
    partial class AddIsOnlineToUserSessions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Eternity.Domain.Entities.RegistrationRequest", b =>
                {
                    ...
                    b.HasIndex("UserName")
                        .HasDatabaseName("ix_registration_requests_user_name");
            ...
            modelBuilder.Entity("Eternity.Domain.Entities.UserSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("IsTerminated", "RefreshTokenExpiry")
                        .HasDatabaseName("ix_user_sessions_is_terminated_refresh_token_expiry");

                    b.HasIndex("UserId", "IsTerminated")
                        .HasDatabaseName("ix_user_sessions_user_id_is_terminated");

                    b.HasIndex("IsTerminated", "EndedAt", "RefreshTokenExpiry")
